...
let button = tv({
  ...
  variants: {
    variant: {
      primary: 'bg-fuchsia-600 hover:bg-fuchsia-700 pressed:bg-fuchsia-800 dark:bg-fuchsia-700 dark:hover:bg-fuchsia-800 dark:pressed:bg-fuchsia-900 text-white',
